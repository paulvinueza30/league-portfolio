...
export default function ChampSelectScreen() {
  ...
  // const navigate = useNavigate(); // Remove or comment out if not used elsewhere
  ...
  return (
    ...
    >
      <div className="absolute top-4 left-4 z-50 flex flex-col items-center">
        <BackButton /> {/* Use the reusable BackButton component */}
      </div>
      <MyJoyRide />
      <div className="flex flex-col gap-2 md:gap-2 lg:gap-3 xl:gap-4 2xl:gap-6 flex-shrink md:flex-1 min-h-0 justify-start">
        ...
        <div className="flex flex-row flex-shrink md:flex-1 min-h-0 max-h-[30vh] md:max-h-none justify-between items-center">
          ...
          <div className="inline-flex justify-center relative flex-1 max-w-full items-end py-0 sm:py-0 md:py-2">
            {!isLockedIn && <HextechCircle />}
            <div className="z-10 hero-section flex justify-center self-end">
